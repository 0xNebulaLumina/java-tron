...
cp ../archive/7.embedded-java.log ./
...
echo "+ output-directory/execution-csv/20251022-070101-d2fbbe44-embedded-embedded.csv"
echo "+ output-directory/execution-csv/$NEWEST_CSV"
echo "respectively."
echo ""
echo "you will help me debug and figure out why there are mismatches, starting from the first tx."
echo ""
echo "(embedded execution + embedded storage) java log: 7.embedded-java.log"
