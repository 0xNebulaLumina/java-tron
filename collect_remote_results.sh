...
echo "+ output-directory/execution-csv/20251030-055539-b3bf2f9c-embedded-embedded.csv"
echo "+ $NEWEST_CSV"
echo "respectively."
echo ""
echo "you will help me debug and figure out why there are mismatches, starting from the first tx."
echo ""
echo "(embedded execution + embedded storage) java log: 4.embedded-java.log"
