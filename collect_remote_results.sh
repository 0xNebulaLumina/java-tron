...
echo "+ output-directory/execution-csv/20251023-085609-24d1fac9-embedded-embedded.csv"
echo "+ $NEWEST_CSV"
echo "respectively."
echo ""
echo "you will help me debug and figure out why there are mismatches, starting from the first tx."
echo ""
echo "(embedded execution + embedded storage) java log: 1.embedded-java.log"
