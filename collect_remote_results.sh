...
cp ../archive/2.embedded-java.log ./
...
echo "+ output-directory/execution-csv/20251027-040703-4abab9f8-embedded-embedded.csv"
echo "+ $NEWEST_CSV"
echo "respectively."
echo ""
echo "you will help me debug and figure out why there are mismatches, starting from the first tx."
echo ""
echo "(embedded execution + embedded storage) java log: 2.embedded-java.log"
