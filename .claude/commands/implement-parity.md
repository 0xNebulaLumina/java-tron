I have a design plan in $1 and $2, which you will implement accordingly.

Some rules:
* Always strive for full parity.
* If any fix, feature, or test (except end-to-end tests) in $2 is not completed, add them proactively so I don't have to ask you to.
