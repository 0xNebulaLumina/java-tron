...
const TESTNET_GENESIS_GUARD_REPS: [[u8; 21]; 11] = [
    [
        0xa0, 0x29, 0x9f, 0x3d, 0xb8, 0x0a, 0x24, 0xb2, 0x0a, 0x25, 0x4b, 0x89, 0xce, 0x63, 0x9d,
        0x59, 0x13, 0x2f, 0x15, 0x7f, 0x13,
    ],
    [
        0xa0, 0x80, 0x73, 0x37, 0xf1, 0x80, 0xb6, 0x2a, 0x77, 0x57, 0x63, 0x77, 0xc1, 0xd0, 0xc9,
        0xc2, 0x4d, 0xf5, 0xc0, 0xdd, 0x62,
    ],
    [
        0xa0, 0x54, 0x30, 0xa3, 0xf0, 0x89, 0x15, 0x4e, 0x9e, 0x18, 0x2d, 0xdd, 0x6f, 0xe1, 0x36,
        0xa6, 0x23, 0x21, 0xaf, 0x22, 0xa7,
    ],
    [
        0xa0, 0x8b, 0xea, 0xa1, 0xa8, 0xe2, 0xd4, 0x53, 0x67, 0xaf, 0x7b, 0xae, 0x7c, 0x49, 0x0b,
        0x99, 0x32, 0xa4, 0xfa, 0x43, 0x01,
    ],
    [
        0xa0, 0xb0, 0x70, 0xb2, 0xb5, 0x8f, 0x43, 0x28, 0xe2, 0x93, 0xdc, 0x9d, 0x60, 0x12, 0xf5,
        0x9c, 0x26, 0x3d, 0x3a, 0x1d, 0xf6,
    ],
    [
        0xa0, 0x0a, 0x93, 0x09, 0x75, 0x85, 0x08, 0x41, 0x30, 0x39, 0xe4, 0xbc, 0x5a, 0x3d, 0x11,
        0x3f, 0x3e, 0xcc, 0x55, 0x03, 0x1d,
    ],
    [
        0xa0, 0x6a, 0x17, 0xa4, 0x96, 0x48, 0xa8, 0xad, 0x32, 0x05, 0x5c, 0x06, 0xf6, 0x0f, 0xa1,
        0x4a, 0xe4, 0x6d, 0xf9, 0x4c, 0xc1,
    ],
    [
        0xa0, 0xec, 0x65, 0x25, 0x97, 0x9a, 0x35, 0x1a, 0x54, 0xfa, 0x09, 0xfe, 0xa6, 0x4b, 0xeb,
        0x4c, 0xce, 0x33, 0xff, 0xbb, 0x7a,
    ],
    [
        0xa0, 0xfa, 0xb5, 0xfb, 0xf6, 0xaf, 0xb6, 0x81, 0xe4, 0xe3, 0x7e, 0x9d, 0x33, 0xbd, 0xdb,
        0x7e, 0x92, 0x3d, 0x61, 0x32, 0xe5,
    ],
    [
        0xa0, 0x14, 0xee, 0xbe, 0x4d, 0x30, 0xa6, 0xac, 0xb5, 0x05, 0xc8, 0xb0, 0x0b, 0x21, 0x8b,
        0xdc, 0x47, 0x33, 0x43, 0x3c, 0x68,
    ],
    [
        0xa0, 0x47, 0x11, 0xbf, 0x7a, 0xfb, 0xdf, 0x44, 0x55, 0x7d, 0xef, 0xbd, 0xf4, 0xc4, 0xe7,
        0xaa, 0x61, 0x38, 0xc6, 0x33, 0x1f,
    ],
];

const MAINNET_GENESIS_GUARD_REPS: [[u8; 21]; 27] = [
    [
        0x41, 0x50, 0x95, 0xd4, 0xf4, 0xd2, 0x6e, 0xbc, 0x67, 0x2c, 0xa1, 0x2f, 0xc0, 0xe3, 0xa4,
        0x8d, 0x6c, 0xe3, 0xb1, 0x69, 0xd2,
    ],
    [
        0x41, 0xd3, 0x2b, 0x3f, 0xa8, 0xca, 0x0b, 0x48, 0x96, 0x25, 0x7f, 0xdf, 0x18, 0x21, 0xac,
        0x8d, 0x11, 0x6d, 0xa8, 0x4c, 0x45,
    ],
    [
        0x41, 0xdf, 0x3b, 0xd4, 0xe0, 0x46, 0x35, 0x34, 0xcb, 0x7f, 0x1f, 0x3f, 0xfc, 0x2e, 0xc1,
        0x4a, 0xc4, 0x69, 0x3d, 0xc3, 0xb2,
    ],
    [
        0x41, 0x27, 0xa6, 0x41, 0x9b, 0xbe, 0x59, 0xf4, 0xe6, 0x4a, 0x06, 0x4d, 0x71, 0x07, 0x87,
        0xe5, 0x78, 0xa1, 0x50, 0xd6, 0xa7,
    ],
    [
        0x41, 0x08, 0xb5, 0x5b, 0x26, 0x11, 0xec, 0x82, 0x9d, 0x30, 0x8a, 0x62, 0xb3, 0x33, 0x9f,
        0xba, 0x9d, 0xd5, 0xc2, 0x71, 0x51,
    ],
    [
        0x41, 0x64, 0x19, 0x76, 0x5b, 0xac, 0xf1, 0xdc, 0x44, 0x1f, 0x72, 0x2c, 0xab, 0xc8, 0xb6,
        0x61, 0x14, 0x05, 0x58, 0xbb, 0x5d,
    ],
    [
        0x41, 0x4b, 0x47, 0x78, 0xbe, 0xeb, 0xb4, 0x8a, 0xbe, 0x0b, 0xc1, 0xdf, 0x42, 0xe9, 0x2e,
        0x0f, 0xe6, 0x4d, 0x0c, 0x86, 0x85,
    ],
    [
        0x41, 0x16, 0x61, 0xf2, 0x53, 0x87, 0x37, 0x0c, 0x9c, 0xd3, 0xa9, 0xa5, 0xd9, 0x7e, 0x60,
        0xca, 0x90, 0xf4, 0x84, 0x4e, 0x7e,
    ],
    [
        0x41, 0xe4, 0x0d, 0xe6, 0x89, 0x5c, 0x14, 0x2a, 0xde, 0x8b, 0x86, 0x19, 0x40, 0x63, 0xbc,
        0xdb, 0xaa, 0x6c, 0x93, 0x60, 0xb6,
    ],
    [
        0x41, 0x20, 0x7a, 0xb1, 0x58, 0x5b, 0x9c, 0xc6, 0xc4, 0xc1, 0x23, 0x2f, 0x67, 0xe4, 0xa1,
        0x0e, 0x19, 0xa4, 0x42, 0xfe, 0x68,
    ],
    [
        0x41, 0x41, 0x0e, 0x46, 0x89, 0x19, 0x15, 0x5a, 0xa8, 0x47, 0xd8, 0x3b, 0x0c, 0x20, 0x61,
        0x48, 0x51, 0x1b, 0x6d, 0xc8, 0x48,
    ],
    [
        0x41, 0x86, 0xf5, 0x79, 0x3e, 0xb6, 0x78, 0xc6, 0x5d, 0x96, 0x73, 0xd5, 0x49, 0x8c, 0x55,
        0x04, 0x39, 0xd7, 0x62, 0xc1, 0xcc,
    ],
    [
        0x41, 0x70, 0x40, 0x58, 0x31, 0x33, 0xe8, 0x31, 0x95, 0x3e, 0xa4, 0xf6, 0x5a, 0x81, 0x96,
        0xfc, 0xff, 0xcf, 0xbf, 0x0d, 0x80,
    ],
    [
        0x41, 0x2e, 0xdc, 0xe1, 0x51, 0xc8, 0x1d, 0x9b, 0x4a, 0xae, 0x17, 0xf9, 0x74, 0xf7, 0xf6,
        0x46, 0x24, 0x2e, 0xff, 0x98, 0x9d,
    ],
    [
        0x41, 0xff, 0xd5, 0x64, 0x65, 0x65, 0x56, 0xa8, 0xb6, 0xb7, 0x93, 0x11, 0xa9, 0x32, 0xe3,
        0xd2, 0x16, 0xf4, 0xfc, 0x03, 0x0b,
    ],
    [
        0x41, 0x45, 0x93, 0xd2, 0x7b, 0x70, 0xd2, 0x14, 0x54, 0xb3, 0x9a, 0xb6, 0x0b, 0xf1, 0x32,
        0x91, 0xda, 0xe8, 0xdc, 0x03, 0x26,
    ],
    [
        0x41, 0x74, 0x6e, 0x6a, 0xf4, 0xac, 0x9d, 0xb3, 0x47, 0x3c, 0x0c, 0x95, 0x5f, 0x1f, 0xca,
        0x11, 0xd4, 0x01, 0x3f, 0x32, 0xed,
    ],
    [
        0x41, 0xe7, 0x2d, 0x83, 0x3e, 0x0c, 0x46, 0x83, 0x7c, 0x08, 0x02, 0x86, 0x4a, 0xcc, 0x5f,
        0x11, 0x9a, 0x0a, 0x90, 0x4d, 0x05,
    ],
    [
        0x41, 0xf8, 0xc7, 0xac, 0xc4, 0xc0, 0x8c, 0xf3, 0x6c, 0xa0, 0x8f, 0xc2, 0xa6, 0x1b, 0x1f,
        0x5a, 0x7c, 0x8d, 0xea, 0x7b, 0xec,
    ],
    [
    ...
    [
        0x41, 0x06, 0x94, 0x98, 0x1b, 0x11, 0x63, 0x04, 0xed, 0x21, 0xe0, 0x58, 0x96, 0xfb, 0x16,
        0xa6, 0xbc, 0x2e, 0x91, 0xc9, 0x2c,
    ],
    [
    ...
    [
        0x41, 0x31, 0x8b, 0x2b, 0x6b, 0x4c, 0x7f, 0xca, 0xa4, 0xb6, 0x2f, 0x25, 0xa2, 0x82, 0x32,
        0x9e, 0x19, 0x52, 0xa3, 0xc0, 0xd1,
    ],
    [
        0x41, 0xa8, 0x57, 0x36, 0x2c, 0x1b, 0x77, 0xcb, 0x04, 0xe8, 0xf2, 0xb5, 0x1b, 0x6e, 0x97,
        0x0f, 0x24, 0xfa, 0x5c, 0x1e, 0x5b,
    ],
    [
        0x41, 0xa8, 0xbb, 0x76, 0x80, 0xd8, 0x5f, 0x98, 0x21, 0xb3, 0xd8, 0x25, 0x05, 0xed, 0xc4,
        0x66, 0x3f, 0x6f, 0xbd, 0x8f, 0xde,
    ],
    [
        0x41, 0x27, 0xbf, 0x0d, 0x1a, 0x57, 0xf3, 0x35, 0xc1, 0x1b, 0xc5, 0xd0, 0x02, 0xdd, 0x82,
        0xe9, 0xe0, 0x72, 0x7c, 0xb9, 0x67,
    ],
    [
        0x41, 0x72, 0xfd, 0x5d, 0xfb, 0x8a, 0xb3, 0x6e, 0xb2, 0x8d, 0xf8, 0xe4, 0xae, 0xe9, 0x79,
        0x66, 0xa6, 0x0e, 0xbf, 0x9e, 0xfe,
    ],
];
...
fn decode_guard_reps_from_config(base58_list: &[String]) -> Vec<Vec<u8>> {
    base58_list
        .iter()
        .filter_map(
            |addr| match tron_backend_common::from_tron_base58_to_bytes(addr) {
...
impl BackendService {
    ...
    pub(crate) fn execute_withdraw_balance_contract(
        ...
        let config_guard_reps =
            decode_guard_reps_from_config(&config.remote.genesis_guard_representatives_base58);
        ...
        let witness_allowance_frozen_time = storage_adapter
            .get_witness_allowance_frozen_time()
            .map_err(|e| format!("Failed to read witness allowance frozen time: {}", e))?;

        let latest_withdraw_time = storage_adapter
            .get_account_latest_withdraw_time(&owner_address)
            .map_err(|e| format!("Failed to read latest withdraw time: {}", e))?;

        debug!(
            "Cooldown check: now_ms={}, latest_withdraw_time={}, frozen_time_days={}",
        ...
        if time_since_last_withdraw < cooldown_ms {
            warn!(
                "Cooldown not satisfied: time_since_last_withdraw={} < cooldown_ms={}",
                time_since_last_withdraw, cooldown_ms
            );
            return Err(format!(
                "The last withdraw time is {}, less than 24 hours",
                latest_withdraw_time
            ));
        }

        debug!(
            "Cooldown satisfied: {} ms since last withdraw (required: {} ms)",
            time_since_last_withdraw, cooldown_ms
        );
        ...
        let new_balance = old_balance
            ...
            .ok_or_else(|| format!("overflow: checkedAdd({}, {})", old_balance, allowance))?;
        ...
        storage_adapter
            .set_account(owner_address, new_owner.clone())
        ...
        let withdraw_changes = vec![WithdrawChange {
            owner_address,
            amount: allowance,
...
mod tests {
    ...
    fn test_guard_rep_config_overrides_hardcoded() {
        ...
        assert!(is_genesis_guard_representative(
            &custom_addr,
            0x41,
            &config_guard_reps
        ));
