...
public class StateChangeJournal {
  ...
  /**
   * Serialize AccountCapsule to byte array using shared AccountInfoCodec.
   * This ensures byte-for-byte parity with TRC-10 synthesis and remote execution.
   */
  private byte[] serializeAccountInfo(AccountCapsule account) {
    return AccountInfoCodec.serialize(account);
  }
