...
/**
 * Adapter that implements the simplified StorageBackend interface using the full StorageSPI.
 * This bridges the gap between the chainbase module's simplified interface and
 * the framework module's full StorageSPI implementation.
 */
@Slf4j(topic = "Storage")
public class StorageSpiBackendAdapter implements StorageBackend {
    ...
    /**
     * Adapter that implements the simplified StorageIterator interface using the full StorageIterator.
     */
