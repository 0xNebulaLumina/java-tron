...
/**
 * Performance benchmark tests for embedded RocksDB StorageSPI implementation.
 * Tests embedded storage performance to compare against gRPC implementation.
 */
public class EmbeddedStoragePerformanceBenchmark extends BasePerformanceBenchmark {
    ...
    protected void initializeStorage(StorageConfig config) throws Exception {
        storage.initDB(benchmarkDbName, config).get(TIMEOUT_SECONDS, java.util.concurrent.TimeUnit.SECONDS);
    }
