 ...
 *
 * <p>A golden vector represents a specific transaction scenario with expected results that can be
 * used to verify the equivalence between different execution engines.
 */
public class GoldenVector {
  ...
  public String toString() {
    return String.format(
        "GoldenVector{name='%s', category='%s', contractCall=%s, description='%s'}",
  ...
  public static class ExpectedResult {
    ...
    public String toString() {
      return String.format(
          "ExpectedResult{success=%s, energy=%d, bandwidth=%d, stateChanges=%d, error='%s'}",
    ...
    public GoldenVector build() {
      ...
      ExpectedResult expectedResult =
          new ExpectedResult(
              ...
              expectedStateChangesCount,
              expectedBandwidthUsed);
