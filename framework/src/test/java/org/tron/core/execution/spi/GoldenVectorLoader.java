...
public class GoldenVectorLoader {
  ...
  private static Map<String, String> parseTestAddresses(JsonNode addressesNode) {
    ...
    if (addressesNode != null) {
      addressesNode.fields().forEachRemaining(entry -> 
          addresses.put(entry.getKey(), entry.getValue().asText()));
    }
    return addresses;
  }
   ...
   */
  private static GoldenVector parseGoldenVector(JsonNode vectorNode, Map<String, String> testAddresses) {
    String name = vectorNode.get("name").asText();
    String category = vectorNode.get("category").asText();
    String description = vectorNode.has("description") ? vectorNode.get("description").asText() : "";
    String transactionType = vectorNode.get("transaction_type").asText();
    
    // Parse transaction parameters
    JsonNode parametersNode = vectorNode.get("parameters");
    TransactionCapsule transaction = createTransaction(transactionType, parametersNode, testAddresses);
   ...
   */
  private static TransactionCapsule createTransaction(String transactionType, JsonNode parameters, 
                                                    Map<String, String> testAddresses) {
    try {
      switch (transactionType) {
        ...
        default:
          throw new UnsupportedOperationException("Unsupported transaction type: " + transactionType);
      }
    } catch (Exception e) {
   ...
   */
  private static TransactionCapsule createTransferTransaction(JsonNode parameters, 
                                                            Map<String, String> testAddresses) {
    ...
    Protocol.Transaction.Builder txBuilder = Protocol.Transaction.newBuilder().setRawData(rawBuilder);
   ...
   */
  private static TransactionCapsule createTriggerSmartContractTransaction(JsonNode parameters, 
                                                                        Map<String, String> testAddresses) {
    String fromAddress = resolveAddress(parameters.get("from").asText(), testAddresses);
   ...
   */
  private static TransactionCapsule createCreateSmartContractTransaction(JsonNode parameters, 
                                                                       Map<String, String> testAddresses) {
  ...
  private static TransactionCapsule createTransferAssetTransaction(JsonNode parameters, 
                                                                 Map<String, String> testAddresses) {
  ...
  private static TransactionCapsule createFreezeBalanceV2Transaction(JsonNode parameters, 
                                                                   Map<String, String> testAddresses) {
    // Placeholder - would implement Stake 2.0 freeze
    throw new UnsupportedOperationException("FreezeBalanceV2Contract not yet implemented in loader");
  }
  
  private static TransactionCapsule createUnfreezeBalanceV2Transaction(JsonNode parameters, 
                                                                     Map<String, String> testAddresses) {
    // Placeholder - would implement Stake 2.0 unfreeze
    throw new UnsupportedOperationException("UnfreezeBalanceV2Contract not yet implemented in loader");
  }
  
  private static TransactionCapsule createDelegateResourceTransaction(JsonNode parameters, 
                                                                    Map<String, String> testAddresses) {
    // Placeholder - would implement resource delegation
    throw new UnsupportedOperationException("DelegateResourceContract not yet implemented in loader");
  }
  
  private static TransactionCapsule createVoteWitnessTransaction(JsonNode parameters, 
                                                               Map<String, String> testAddresses) {
  ...
  private static TransactionCapsule createShieldedTransferTransaction(JsonNode parameters, 
                                                                    Map<String, String> testAddresses) {
    // Placeholder - would implement shielded transfer
    throw new UnsupportedOperationException("ShieldedTransferContract not yet implemented in loader");
  }
  
  private static TransactionCapsule createMarketSellAssetTransaction(JsonNode parameters, 
                                                                   Map<String, String> testAddresses) {
    // Placeholder - would implement market sell order
    throw new UnsupportedOperationException("MarketSellAssetContract not yet implemented in loader");
  }
  ...
  private static GoldenVector.ExpectedResult parseExpectedResult(JsonNode expectedNode) {
    ...
    long bandwidthUsed = expectedNode.has("bandwidth_used") ? expectedNode.get("bandwidth_used").asLong() : 0;
    int stateChanges = expectedNode.has("state_changes") ? expectedNode.get("state_changes").asInt() : -1;
    ...
    return new GoldenVector.ExpectedResult(success, energyUsed, returnData, errorMessage, 
                                         stateChanges, bandwidthUsed);
  }
